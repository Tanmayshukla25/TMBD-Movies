  ...
  useEffect(() => {
    async function fetchMovies() {
      try {
        ...
        const validMovies = result.results.filter((movie) => movie.backdrop_path);
  ...
  return (
    <div>
      {randomBackdrop && (
        ...
        >
          <div className="absolute inset-0 bg-black/60 grid place-content-center">
            <h1 className="text-white text-4xl md:text-7xl font-extrabold text-center">Welcome.</h1>
      ...
      {searchResults.length > 0 && (
        <div className="">
          <h2 className="text-white text-2xl mb-4 text-center">Search Results</h2>
